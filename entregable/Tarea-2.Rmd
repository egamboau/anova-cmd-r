...
references:
  ...
  - id: anova-shapiro-wilk
    ...
    author: 
    - family: No conocido.
    URL: https://vivaelsoftwarelibre.com/test-de-shapiro-wilk-para-contrastar-la-normalidad-en-r-commander/
  - id: anova-bartlett
    title: Test de Bartlett
    author: 
    - family: No conocido.
    URL: https://vivaelsoftwarelibre.com/test-de-bartlett-para-contrastar-la-homocedasticidad-de-mas-de-2-muestras-usando-r-commander/
nocite: |
...
Cuanto más se aproximen los datos a una normal, más alineados están los puntos entorno a la recta. Vemos una anormalidad en el primer punto que se encuentra muy alejado de la recta, pero los demas se encuentran relativamente cerca.
